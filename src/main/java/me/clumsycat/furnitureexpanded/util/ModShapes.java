...
public class ModShapes {
    ...
    //   Shower Box
    // ==============
    public static final VoxelShape SHOWER_BOX_TOP_N = Stream.of(Block.box(0, 0, 0, 1, 16, 16), Block.box(1, 0, 15, 15, 16, 16), Block.box(1, 15, 0, 15, 16, 1), Block.box(15, 0, 0, 16, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_TOP_E = Stream.of(Block.box(0, 0, 0, 16, 16, 1), Block.box(0, 0, 1, 1, 16, 15), Block.box(15, 15, 1, 16, 16, 15), Block.box(0, 0, 15, 16, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_TOP_S = Stream.of(Block.box(15, 0, 0, 16, 16, 16), Block.box(1, 0, 0, 15, 16, 1), Block.box(1, 15, 15, 15, 16, 16), Block.box(0, 0, 0, 1, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_TOP_W = Stream.of(Block.box(0, 0, 15, 16, 16, 16), Block.box(15, 0, 1, 16, 16, 15), Block.box(0, 15, 1, 1, 16, 15), Block.box(0, 0, 0, 16, 16, 1)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_BOTTOM_N = Stream.of(Block.box(1, 0, 1, 15, 1, 15), Block.box(1, 0, 0, 15, 2, 1), Block.box(0, 0, 0, 1, 16, 16), Block.box(1, 0, 15, 15, 16, 16), Block.box(15, 0, 0, 16, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_BOTTOM_E = Stream.of(Block.box(1, 0, 1, 15, 1, 15), Block.box(15, 0, 1, 16, 2, 15), Block.box(0, 0, 0, 16, 16, 1), Block.box(0, 0, 1, 1, 16, 15), Block.box(0, 0, 15, 16, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_BOTTOM_S = Stream.of(Block.box(1, 0, 1, 15, 1, 15), Block.box(1, 0, 15, 15, 2, 16), Block.box(15, 0, 0, 16, 16, 16), Block.box(1, 0, 0, 15, 16, 1), Block.box(0, 0, 0, 1, 16, 16)).reduce(Shapes::or).get();
    public static final VoxelShape SHOWER_BOX_BOTTOM_W = Stream.of(Block.box(1, 0, 1, 15, 1, 15), Block.box(0, 0, 1, 1, 2, 15), Block.box(0, 0, 15, 16, 16, 16), Block.box(15, 0, 1, 16, 16, 15), Block.box(0, 0, 0, 16, 16, 1)).reduce(Shapes::or).get();
    ...
    // Bathroom Sink
    // ==============
    public static final VoxelShape BATHROOM_SINK_N = Stream.of(Block.box(4, 0, 6, 12, 9, 15), Block.box(2, 9, 3, 14, 11, 16), Block.box(0, 11, 0, 16, 16, 16), Block.box(7, 16, 13.5, 9, 20, 15.5), Block.box(7, 20, 9.5, 9, 21, 14.5), Block.box(7.25, 19.25, 9.75, 8.75, 20, 11.25), Block.box(9, 17, 14, 11, 18, 15)).reduce(Shapes::or).get();
    public static final VoxelShape BATHROOM_SINK_E = Stream.of(Block.box(1, 0, 4, 10, 9, 12), Block.box(0, 9, 2, 13, 11, 14), Block.box(0, 11, 0, 16, 16, 16), Block.box(0.5, 16, 7, 2.5, 20, 9), Block.box(1.5, 20, 7, 6.5, 21, 9), Block.box(4.75, 19.25, 7.25, 6.25, 20, 8.75), Block.box(1, 17, 9, 2, 18, 11)).reduce(Shapes::or).get();
    public static final VoxelShape BATHROOM_SINK_S = Stream.of(Block.box(4, 0, 1, 12, 9, 10), Block.box(2, 9, 0, 14, 11, 13), Block.box(0, 11, 0, 16, 16, 16), Block.box(7, 16, 0.5, 9, 20, 2.5), Block.box(7, 20, 1.5, 9, 21, 6.5), Block.box(7.25, 19.25, 4.75, 8.75, 20, 6.25), Block.box(5, 17, 1, 7, 18, 2)).reduce(Shapes::or).get();
    public static final VoxelShape BATHROOM_SINK_W = Stream.of(Block.box(6, 0, 4, 15, 9, 12), Block.box(3, 9, 2, 16, 11, 14), Block.box(0, 11, 0, 16, 16, 16), Block.box(13.5, 16, 7, 15.5, 20, 9), Block.box(9.5, 20, 7, 14.5, 21, 9), Block.box(9.75, 19.25, 7.25, 11.25, 20, 8.75), Block.box(14, 17, 5, 15, 18, 7)).reduce(Shapes::or).get();
